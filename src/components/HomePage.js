...
import { getSayings, getAllRegions, clearCurrentTag, setPreviousPath } from '../actions/getSayings'
...
export default connect(null, { getAllRegions, getSayings, clearCurrentTag, setPreviousPath })(HomePage)
